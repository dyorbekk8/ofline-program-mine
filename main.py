...
async def send_telegram_dm(session_string, target, message):
  ...
  try:
    ...
    logger.info(f"[Telegram Real] Xabar muvaffaqiyatli yuborildi -> {target}")
  finally:
    ...
    try:
      ...
      for lead in pending_leads:
        ...
        if success and acc_key and acc_data:
          ...
          logger.warning(f"Xabar yuborilmadi, status 'Pending' holatida qoldirildi: {target}")
